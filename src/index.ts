...
export function getBzlmodVersion(version: string): BzlmodVersion {
 ...
 */
export function equals(version: string, other: string): boolean {
 ...
 */
export function isGreaterThan(version: string, other: string): boolean {
  const abv = new BzlmodVersion(version);
  const bbv = new BzlmodVersion(other);
 ...
 * the `range`.
 */
export function isLessThanRange(version: string, range: string): boolean {
  const abv = new BzlmodVersion(version);
 ...
 */
export function sortVersions(version: string, other: string): number {
  const abv = new BzlmodVersion(version);
  const bbv = new BzlmodVersion(other);
 ...
 */
export function isSingleVersion(version: string): boolean {
  return isValid(version);
}
